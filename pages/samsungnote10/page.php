...
<body>
	...
	<article>
		...
		<b style='font-size: 150%;color:red;width:200px;height: 100px;border-radius: 5px;'><pre>price:Rs 69999  <del>Rs72000</del></b></pre>
		<?php
		...
		?>
		    Display Size :  14.73 cm (6.1 inch)<br><div style='width:500px;margin-left: 150px;font-size: 50%;'><p>
														 <h1> highlights :   </h1><br>8 GB RAM <br> 256 GB ROM <br>
  														16.00 cm (6.1 inch) Display<br>
														 12 MP + 12 MP + 16 MP Rear Camera | 10 MP Front Camera<br>
														 3500 mah Battery<br>
                                                        ...
                                                        Model Number  : SM-N970FZKDINS<br>
                                                        
                                                        Model Name  : Galaxy Note 10 <br>
							...
							<br>							
                                                        ...
                                                        Display Size :  16.00 cm (6.1 inch)<br>

                                                        Resolution : 2280 x 1080 pixel <br>
							...
							Operating System: Android Pie Oxygen <br>
