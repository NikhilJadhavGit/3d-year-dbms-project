...
<body>
	...
	<article>
		...
		<?php
			...
			$spaces=0;
			$result=mysqli_query($conn,"SELECT images.path,products.name,products.price,products.model, products.link  FROM images,products,product_images WHERE products.p_id=product_images.p_id AND images.i_id=product_images.i_id AND product_images.p_id=product_images.i_id AND products.tag='headphone' ");
