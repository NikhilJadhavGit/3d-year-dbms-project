...
<body>
	...
	<article>
		...
		<div id="content">
			<h1>ONE PLUS 6T</h1>
		<b style='font-size: 150%;color:red;width:200px;height: 100px;border-radius: 5px;'><pre>price:Rs 31999  <del>Rs39900</del></b></pre>
		<?php
		...
		?>
			<div style='width:500px;margin-left: 150px;font-size: 50%;'><p>
                                                        ...
                                                        Model Number  :A6010<br>
                                                        
                                                        Model Name  :6T <br>
														
							Color  :Mirror Black<br>
							...
							Quick Charging :Yes<br>
                                                       ...
                                                       Internal Storage : 128 GB <br>

							RAM : 6 GB <br>

							Memory Card Slot Type : Hybrid Slot <br>
							...
							Battery Capacity : 3700 mAh <br>
					                                   ...
					                                   <h1> highlights :   </h1><br>6 GB RAM <br> 128 GB ROM <br>
  														16.28 cm (6.41 inch) Display<br>
														16 MP + 20 MP | 16MP Front Camera<br>
			                                            3700 mAh Battery</p></div>       
		</div>
	</article>
	<footer>
		<div>
