...
<body>
	...
	<article>
		...
		<div id="content">
		<h1>IPHONE X</h1>
		<b style='font-size: 150%;color:red;width:200px;height: 100px;border-radius: 5px;'><pre>price:Rs 69900  <del>Rs91900</del></b></pre>
		<?php
		...
		<div style='width:500px;margin-left: 150px;font-size: 50%;'><p>
														 <h1> highlights :   </h1><br>6 GB RAM <br> 64 GB ROM <br>
  														14.73 cm (5.8 inch) Display<br>
														 12 Mp + 12 MP Rear Camera | 7 MP Front Camera<br>
														 A 11 bionic chip processor<br>
                                                        ...
                                                        Model Number  :MQA62HN/<br>
                                                        
                                                        Model Name  : iPhone X <br>
							...
							Quick Charging :Yes<br>
                                                        ...
                                                        Display Size :  14.73 cm (6.1 inch)<br>

                                                        Resolution : 2436 x 1125 Pixels <br>
							...
							Operating System: Ios 13ss <br>

							Processor Type : A11 Bionic chip <br>
