...
<body>
	...
	<article>
		...
		<b style='font-size: 150%;color:red;width:200px;height: 100px;border-radius: 5px;'><pre>price:Rs 1,09,900  <del>Rs1,15,000</del></b></pre>
		<?php
		...
		<div style='width:500px;margin-left: 150px;font-size: 50%;'><p>
			 <h1> highlights :   </h1><br>6 GB RAM <br> 64 GB ROM <br>
  														16.51 cm (6.5 inch) Display<br>
														 12 MP + 12 MP + 12 MP Rear Camera | 12 MP Front Camera<br>
														 A 13 bionic chip processor<br>
                                                        ...
                                                        Model Number  : MWHG2HN/A<br>
                                                        
                                                        Model Name  : iPhone 11  Pro Max<br>
														
							Color  :  Grey,White,black<br>
							...
							<br>							
                                                        ...
                                                        Display Size :  16.51 cm (6.5 inch)<br>

                                                        Resolution : 2688 x 1242 Pixels <br>
							...
							Processor Type : A13 Bionic chip <br>
